...
const uint16_t PROGMEM keymaps[NUM_LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT(
    ...
    KC_LWIN,  KC_LSFT,  KC_Z,  KC_X,    KC_C,        KC_V,   KC_B,       KC_N,  KC_M,  KC_COMM, KC_DOT, KC_SLSH,  KC_BSLS,  KC_DEL,
                               KC_LALT, MO(LAYER_1), KC_SPC, KC_LCTL,    KC_NO, KC_NO, KC_NO,   KC_NO
  ),

  LAYOUT(
                      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS, KC_MINS, KC_EQL,
             KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_DEL,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
