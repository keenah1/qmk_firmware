...
const uint16_t PROGMEM keymaps[NUM_LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_0] =
    ...
    LAYOUT(
      ...
      KC_ESC,  KC_LSFT, KC_A,    KC_S,          KC_D,        KC_F,   KC_G,               KC_H,   KC_J,   KC_K,           KC_L,   KC_SCLN,  KC_QUOT,  KC_BSPC,
      KC_LWIN, KC_BSPC, KC_Z,    KC_X,          KC_C,        KC_V,   KC_B,               KC_N,   KC_M,   KC_COMM,        KC_DOT, KC_SLSH,  KC_BSLS,  KC_DEL,
