...
const uint16_t PROGMEM keymaps[NUM_LAYERS][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_0] =
     ...
     * ┌─────┼──────┼───────┼──────┼─────┼─────┼─────────┤         ├─────┼──────┼─────┼─────┼─────┼──────┼─────┐
     * │ ESC │ BSPC │ A/NVF │  S   │  D  │  F  │    G    │         │  H  │  J   │  K  │  L  │ ;/: │ '/"  │ SFT │
     * ├─────┼──────┼───────┼──────┼─────┼─────┼─────────┤         ├─────┼──────┼─────┼─────┼─────┼──────┼─────┤
     * │ WIN │ SFT  │ Z/VSC │  X   │  C  │  V  │    B    │         │  N  │  M   │ ,/< │ ./> │ //? │ \/|  │ DEL │
     * └─────┴──────┴───────┼──────┼─────┼─────┼─────────┤         ├─────┼──────┼─────┼─────┼─────┴──────┴─────┘
    ...
    LAYOUT(
      ...
      KC_ESC,  KC_BSPC, LT(LAYER_NAV_F,KC_A), KC_S,           KC_D,    KC_F,   KC_G,               KC_H,   KC_J,           KC_K,    KC_L,   KC_SCLN,  KC_QUOT,  KC_RSFT,
      KC_LWIN, KC_LSFT, LT(LAYER_VSC,KC_Z),   KC_X,           KC_C,    KC_V,   KC_B,               KC_N,   KC_M,           KC_COMM, KC_DOT, KC_SLSH,  KC_BSLS,  KC_DEL,
  ...
  [LAYER_SPCL] =
    ...
    LAYOUT(
      ...
      KC_DEL, KC_TILD, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,        KC_PIPE, KC_UNDS, KC_LABK, KC_LCBR, KC_LBRC, KC_NO, KC_NO,
      KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_PLUS, KC_EQL,       KC_EQL,  KC_MINS, KC_RABK, KC_RCBR, KC_RBRC, KC_NO, KC_NO,
